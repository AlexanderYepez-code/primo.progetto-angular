...
@Component({
  selector: 'app-binding-componenets',
  standalone: true,
  imports: [FormsModule],
  templateUrl: './binding-componenets.component.html',
  styleUrl: './binding-componenets.component.css'
})
export class BindingComponenets {
